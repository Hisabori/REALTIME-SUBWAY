...
<jsp:include page="/src/main/web/WEB-INF/views/common/header.jsp"/>
<div class="날씨">
    <div class="온도"></div>
...
<div class="통행량">
    ...
    <div id="map" style="width: 100%; height: 350px;">
        ...
        <script>
            <%@include file="/src/main/web/WEB-INF/resources/common/api/js/map/service/service.js"%>
        </script>
    </div>
...
<jsp:include page="/src/main/web/WEB-INF/views/common/footer.jsp"/>
